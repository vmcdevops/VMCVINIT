...
function calculateHashValuesSuccess(responseText) {
    ...
    callWPApi("PUT", "/nat_registrations/" + newUserUuid, hdfc_cc_avenue, {
        "Content-Type": "application/json",
    }, JSON.stringify({
        name: document.getElementById('fullname').value,
...
function hdfc_cc_avenue(responseText){
    ...
    callLaravelApi("POST", "/api/hdfc_avenu_data", nat_registrations_success, headers, jsonStr);
...
function startPayment(res) {
   
    

    var createform = document.createElement("form"); // Create New Element Form
    createform.setAttribute("action", res.url); // Setting Action Attribute on Form
    createform.setAttribute("method", "post"); // Setting Method Attribute on Form
    this.createAndAddElementWithTypeNameAndValue("hidden", "redirect", res.url, createform);
    this.createAndAddElementWithTypeNameAndValue("hidden", "encRequest", res.encrypdata, createform);
    this.createAndAddElementWithTypeNameAndValue("hidden", "access_code", res.accesscode, createform);
