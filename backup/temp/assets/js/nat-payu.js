   ...
   // }
    ...
    if (is_app) {
        if (select_test_mode.value == "Online" || select_test_mode.value == "online") {
            if (selectedNatDate.id == 362 || selectedNatDate.id == 363) {
                couponCodeGlobal = 'NAT399';
            ...
            if (selectedNatDate.id == 365 || selectedNatDate.id == 366) {
                couponCodeGlobal = 'NAT399';
                applyCouponWithCouponCode(couponCodeGlobal);
                document.getElementById("couponCode").disabled = dalse;
                document.getElementById("couponCode").value = couponCodeGlobal;
            ...
            if (select_test_mode.value == "Offline" || select_test_mode.value == "offline") {
                if (selectedNatDate.id == 361) {
                    couponCodeGlobal = 'NAT199';
                    applyCouponWithCouponCode(couponCodeGlobal);
                    document.getElementById("couponCode").disabled = dalse;
                    document.getElementById("couponCode").value = couponCodeGlobal;
                }
                if (selectedNatDate.id == 362) {
                    couponCodeGlobal = 'NAT199';
                    applyCouponWithCouponCode(couponCodeGlobal);
                    document.getElementById("couponCode").disabled = dalse;
                    document.getElementById("couponCode").value = couponCodeGlobal;
                }
                if (selectedNatDate.id == 364) {
                    couponCodeGlobal = 'NAT199';
                    applyCouponWithCouponCode(couponCodeGlobal);
                    document.getElementById("couponCode").disabled = dalse;
                    document.getElementById("couponCode").value = couponCodeGlobal;
...
function changePriceCoupon() {
    ...
    if (is_app) {
        if (examType == 2) {
            if (select_test_mode.value == "Online" || select_test_mode.value == "online") {
                if ((selectedNatDate.id == 362 || selectedNatDate.id == 363 || selectedNatDate.id == 365 || selectedNatDate.id == 366) && (select_course.value == 23 || select_course.value == 13 || select_course.value == 32 || select_course.value == 63)) {
                    document.getElementById("couponCode").value = 'NATMED99';
                } else if ((selectedNatDate.id == 362 || selectedNatDate.id == 363 || selectedNatDate.id == 365 || selectedNatDate.id == 366) &&
                    (centre_code == 176 || centre_code == 178 || centre_code == 121 || centre_code == 174 || centre_code == 177 || centre_code == 170 || centre_code == 127 || centre_code == 128 ||
                        ...
                        centre_code == 159 || centre_code == 161 || centre_code == 172)) {
                    document.getElementById("couponCode").value = 'NAT499';
                    //NATFOUNDATION0
    
                } else if ((selectedNatDate.id == 362 || selectedNatDate.id == 363) && (select_course.value != 23 || select_course.value != 13 || select_course.value != 32 || select_course.value != 63)) {
                    document.getElementById("couponCode").value = 'NAT399';
                } else if ((selectedNatDate.id == 365 || selectedNatDate.id == 366) && (select_course.value != 23 || select_course.value != 13 || select_course.value != 32 || select_course.value != 63)) {
                    document.getElementById("couponCode").value = 'NAT399';
                }  
                ...
                if (select_test_mode.value == "Offline" || select_test_mode.value == "offline") {
                    if (select_course.value == 23 || select_course.value == 13 || select_course.value == 32 || select_course.value == 63) {
                        document.getElementById("couponCode").value = 'NATMED99';
                    } else if ((selectedNatDate.id == 361 || selectedNatDate.id == 362) && (select_course.value != 23 || select_course.value != 13 || select_course.value != 32 || select_course.value != 63)) {
                        document.getElementById("couponCode").value = 'NAT199';
                    } else if ((selectedNatDate.id == 364 || selectedNatDate.id == 365) && (select_course.value != 23 || select_course.value != 13 || select_course.value != 32 || select_course.value != 63)) {
                        document.getElementById("couponCode").value = 'NAT199';
                    } else {
                        //document.getElementById("couponCode").value = 'VIQ999';
                    }
                }
                document.getElementById("btn_remove_coupon").disabled = true;
                applyCoupon();
...
function getCartSuccess(responseText) {
    ...
    if (defaultCouponApplied == false) {
        ...
        if (is_app) {
            if (examType == 3) {
                document.getElementById("couponCode").value = "VIQPLUS199";
            }
            if (examType == 2) {
                document.getElementById("couponCode").value = 'NAT199';
            }
...
function check_duplicate(responseText) {
    ...
    if (result.status != 200) {
        ...
        if (result.status == 400) {
            document.getElementById("couponCode").value = 'NAT999';
            // if (examType == 2) {
