...
function natDateOptionSelected() {
    ...
    if (is_app) {
        if (select_test_mode.value == "Online" || select_test_mode.value == "online") {
            ...
            if (selectedNatDate.id == 382 || selectedNatDate.id == 383 || selectedNatDate.id == 384 || selectedNatDate.id == 385 || selectedNatDate.id == 387 || selectedNatDate.id == 390) {
                couponCodeGlobal = 'NAT399';
                applyCouponWithCouponCode(couponCodeGlobal);
                document.getElementById("couponCode").disabled = dalse;
                document.getElementById("couponCode").value = couponCodeGlobal;
            }
            if (selectedNatDate.id == 391) {
                couponCodeGlobal = 'NAT499';
                applyCouponWithCouponCode(couponCodeGlobal);
                document.getElementById("couponCode").disabled = dalse;
                document.getElementById("couponCode").value = couponCodeGlobal;
            }
        ...
        if (select_test_mode.value == "Offline" || select_test_mode.value == "offline") {
            if (selectedNatDate.id == 381 || selectedNatDate.id == 383 || selectedNatDate.id == 384 || selectedNatDate.id == 391 || selectedNatDate.id == 390) {
        ...
        if (select_test_mode.value == "Online" || select_test_mode.value == "online") {
            ...
            if (selectedNatDate.id == 382 || selectedNatDate.id == 383 || selectedNatDate.id == 384 || selectedNatDate.id == 391 || selectedNatDate.id == 390) {
                couponCodeGlobal = 'VMCDMRC';
                applyCouponWithCouponCode(couponCodeGlobal);
                document.getElementById("couponCode").disabled = dalse;
                document.getElementById("couponCode").value = couponCodeGlobal;
...
function changePriceCoupon() {
    ...
    if (is_app) {
        if (examType == 2) {
            if (select_test_mode.value == "Online" || select_test_mode.value == "online") {
                if ((selectedNatDate.id == 381 || selectedNatDate.id == 382 || selectedNatDate.id == 383 || selectedNatDate.id == 384 || selectedNatDate.id == 385 || selectedNatDate.id == 387 || selectedNatDate.id == 391 || selectedNatDate.id == 390) && (select_course.value == 23 || select_course.value == 13 || select_course.value == 32 || select_course.value == 63)) {
                    document.getElementById("couponCode").value = 'NATMED99';
                } else if ((selectedNatDate.id == 381 || selectedNatDate.id == 382 || selectedNatDate.id == 383 || selectedNatDate.id == 384 || selectedNatDate.id == 385 || selectedNatDate.id == 391) &&
                ...
                } else if ((selectedNatDate.id == 381 || selectedNatDate.id == 385 || selectedNatDate.id == 391) && (select_course.value != 23 || select_course.value != 13 || select_course.value != 32 || select_course.value != 63)) {
                    document.getElementById("couponCode").value = 'NAT499';
                } else if ((selectedNatDate.id == 382 || selectedNatDate.id == 383 || selectedNatDate.id == 384 || selectedNatDate.id == 385 || selectedNatDate.id == 387 || selectedNatDate.id == 390) && (select_course.value != 23 || select_course.value != 13 || select_course.value != 32 || select_course.value != 63)) {
                ...
                if (select_test_mode.value == "Offline" || select_test_mode.value == "offline") {
                    if (select_course.value == 23 || select_course.value == 13 || select_course.value == 32 || select_course.value == 63) {
                        document.getElementById("couponCode").value = 'NATMED99';
                    } else if ((selectedNatDate.id == 381 || selectedNatDate.id == 387 || selectedNatDate.id == 391) && (select_course.value != 23 || select_course.value != 13 || select_course.value != 32 || select_course.value != 63)) {
                        document.getElementById("couponCode").value = 'NAT199';
                    } else if ((selectedNatDate.id == 382 || selectedNatDate.id == 383 || selectedNatDate.id == 384 || selectedNatDate.id == 387 || selectedNatDate.id == 391) && (select_course.value != 23 || select_course.value != 13 || select_course.value != 32 || select_course.value != 63)) {
                        document.getElementById("couponCode").value = 'NAT199';
                    } else {
        ...
        if (examType == 2) {
            if (select_test_mode.value == "Online" || select_test_mode.value == "online") {
                if ((selectedNatDate.id == 381 || selectedNatDate.id == 382 || selectedNatDate.id == 383 || selectedNatDate.id == 384 || selectedNatDate.id == 391) && (select_course.value == 23 || select_course.value == 13 || select_course.value == 32 || select_course.value == 63)) {
                    document.getElementById("couponCode").value = 'VMCDMRC';
                } else if ((selectedNatDate.id == 381 || selectedNatDate.id == 382 || selectedNatDate.id == 383 || selectedNatDate.id == 384 || selectedNatDate.id == 391) &&
                    (centre_code == 176 || centre_code == 178 || centre_code == 121 || centre_code == 174 || centre_code == 177 || centre_code == 170 || centre_code == 127 || centre_code == 128 ||
                        centre_code == 134 || centre_code == 136 || centre_code == 169 || centre_code == 145 || centre_code == 147 || centre_code == 175 ||
                        centre_code == 182 || centre_code == 179 || centre_code == 180 || centre_code == 181 || centre_code == 154 || centre_code == 156 || centre_code == 155 ||
                        centre_code == 160 || centre_code == 164 || centre_code == 117 || centre_code == 123 || centre_code == 141 || centre_code == 144 || centre_code == 148 || centre_code == 150 ||
                ...
                } else if ((selectedNatDate.id == 381) && (select_course.value != 23 || select_course.value != 13 || select_course.value != 32 || select_course.value != 63)) {
                    document.getElementById("couponCode").value = 'VMCDMRC';
                } else if ((selectedNatDate.id == 381 || selectedNatDate.id == 382 || selectedNatDate.id == 383 || selectedNatDate.id == 384) && (select_course.value != 23 || select_course.value != 13 || select_course.value != 32 || select_course.value != 63)) {
                    document.getElementById("couponCode").value = 'VMCDMRC';
                }
                document.getElementById("btn_remove_coupon").disabled = true;
                applyCoupon();
        ...
        if (select_test_mode.value == "Online" || select_test_mode.value == "online") {
            if ((selectedNatDate.id == 381 || selectedNatDate.id == 382 || selectedNatDate.id == 383 || selectedNatDate.id == 384 || selectedNatDate.id == 385 || selectedNatDate.id == 387 || selectedNatDate.id == 391 || selectedNatDate.id == 390) && (select_course.value == 23 || select_course.value == 13 || select_course.value == 63 || select_course.value == 32)) {
                document.getElementById("couponCode").value = 'NATMED99';
            } else if ((selectedNatDate.id == 381 || selectedNatDate.id == 382 || selectedNatDate.id == 383 || selectedNatDate.id == 384 || selectedNatDate.id == 391) &&
                (centre_code == 176 || centre_code == 178 || centre_code == 121 || centre_code == 174 || centre_code == 177 || centre_code == 170 || centre_code == 127 || centre_code == 128 ||
                    centre_code == 134 || centre_code == 136 || centre_code == 169 || centre_code == 145 || centre_code == 147 || centre_code == 175 ||
            ...
            } else if ((selectedNatDate.id == 381 || selectedNatDate.id == 390) && (select_course.value != 23 || select_course.value != 13 || select_course.value != 32 || select_course.value != 63)) {
                document.getElementById("couponCode").value = 'NAT399';
            } else if ((selectedNatDate.id == 381 || selectedNatDate.id == 382 || selectedNatDate.id == 383 || selectedNatDate.id == 384 || selectedNatDate.id == 385 || selectedNatDate.id == 387 || selectedNatDate.id == 391) && (select_course.value != 23 || select_course.value != 13 || select_course.value != 32 || select_course.value != 63)) {
                document.getElementById("couponCode").value = 'NAT499';
            }
            ...
            if (select_test_mode.value == "Offline" || select_test_mode.value == "offline") {
                if (select_course.value == 23 || select_course.value == 13 || select_course.value == 32 || select_course.value == 63) {
                    document.getElementById("couponCode").value = 'NATMED99';
                } else if ((selectedNatDate.id == 381 || selectedNatDate.id == 387 || selectedNatDate.id == 391 || selectedNatDate.id == 390) && (select_course.value != 23 || select_course.value != 13 || select_course.value != 32 || select_course.value != 63)) {
                    document.getElementById("couponCode").value = 'NAT199';
                } else if ((selectedNatDate.id == 381 || selectedNatDate.id == 382 || selectedNatDate.id == 383 || selectedNatDate.id == 384 || selectedNatDate.id == 387 || selectedNatDate.id == 390) && (select_course.value != 23 || select_course.value != 13 || select_course.value != 32 || select_course.value != 63)) {
                    document.getElementById("couponCode").value = 'NAT199';
                } else {
                    //document.getElementById("couponCode").value = 'VIQ999';
                }
...
function updateUIAsPerCartInfo() {
    ...
    if (isDiscount) {
        htmlInfo = '<span style="font-size: 15px; text-decoration: line-through; text-decoration-color: red;">&#8377 999</span><span style="font-size: 14px; margin-left: 10px;">&#8377 ' + parseInt(userCartSummery.total_amount) + " Only</span>";
    } else {
        ...
        htmlInfo = '<span style="font-size: 15px; text-decoration: line-through; text-decoration-color: red;">&#8377 999</span><span style="font-size: 22px; font-family:cera bold; margin-left: 10px; color:#fecc00">&#8377 ' + Couponlaodproce + " Only</span>";
...
function couponCodeAppliedSuccessfully() {
    ...
    let htmlInfo = '<img id="couponcode_status_img" width="20" height="20" alt="success" src="https://www.vidyamandir.com/img/coupon_apply_success.png"/><span id="couponcode_status_msg" style="margin-left:10px;font-size:12px;color:#fff">Coupon code applied successfully.</span>';
...
function check_duplicate(responseText) {
    ...
    if (result.status != 200) {
        if (result.status == 400) {
            if (center == 151 || center == 152 || center == 153 || center == 195) {
                applyCoupon();
                callapifunc();
            } else {
...
function updateCentersOptions(centerListJSON) {
    ...
    for (i = 0; i < centerListArr.length; i++) {
        ...
        var option = document.createElement("option");
        if (select_test_mode.value == "Offline" || select_test_mode.value == "offline") {
            if (((selectedDateTime == 'VMC NAT 17 Mar 2024 10 AM - 12:30 PM') && (selectedCourse == 62 || selectedCourse == 63))) {
