...
function viqTestCityAddressSelected() {
    ...
    if (center.code == '108' || center.code == '109' || center.code == '110' || center.code == '183') {
...
function updateOfflineCentre(courseListJSON) {
    ...
    for (i = 0; i < courseListArr.length; i++) {
        ...
        if (course.code == '108' || course.code == '109' || course.code == '110' || course.code == '183') {
...
function pageLoaded() {
    ...
    if (urlParams.has('special_link') && urlParams.get('special_link') != "") {
        if ((urlParams.get('special_link') == "NATNOIDA99" || urlParams.get('special_link') == "natnoida99")) {
            is_special = true;
            special_coupon = "NATNOIDA99";
        }
    } else {
        is_special = false;
    }
...
function prepareNatDateOptionsSelection(natDatesList) {
    ...
    for (i = 0; i < natDatesList.length; i++) {
        ...
        if ((natDate.testDate == '2024-03-17') || (natDate.testDate == '2024-03-16')) {
            // if (i == 0) {
        ...
        if (examType == 2) {
            if (select_test_mode.value == "Online" || select_test_mode.value == "online") {
                if ((selectedNatDate.id == 362 || selectedNatDate.id == 363 || selectedNatDate.id == 365 || selectedNatDate.id == 366) && (select_course.value == 23 || select_course.value == 13 || select_course.value == 32 || select_course.value == 63)) {
                    document.getElementById("couponCode").value = 'NATNOIDA99';
...
function check_duplicate(responseText) {
    ...
    if (result.status != 200) {
        if (result.status == 400) {
            if (center == 108 || center == 109 || center == 110 || center == 183) {
                applyCoupon();
                callapifunc();
            } else {
