...
function natDateOptionSelected() {
    ...
    if (is_app) {
        if (select_test_mode.value == "Online" || select_test_mode.value == "online") {
            ...
            //VIQ
            if (selectedNatDate.id == 396 || selectedNatDate.id == 397) {
                couponCodeGlobal = 'VIQDurgaPF';
                applyCouponWithCouponCode(couponCodeGlobal);
                document.getElementById("couponCode").disabled = dalse;
                document.getElementById("couponCode").value = couponCodeGlobal;

            }
            if (selectedNatDate.id == 394 || selectedNatDate.id == 395 || selectedNatDate.id == 398 || selectedNatDate.id == 399) {
                couponCodeGlobal = 'VIQDurgaPF';
                applyCouponWithCouponCode(couponCodeGlobal);
                document.getElementById("couponCode").disabled = dalse;
                document.getElementById("couponCode").value = couponCodeGlobal;
            }
            if (selectedNatDate.id == 400 || selectedNatDate.id == 401) {
                couponCodeGlobal = 'VIQDurgaPF';
                applyCouponWithCouponCode(couponCodeGlobal);
                document.getElementById("couponCode").disabled = dalse;
                document.getElementById("couponCode").value = couponCodeGlobal;
        ...
        if (select_test_mode.value == "Offline" || select_test_mode.value == "offline") {
            //NAT
            if (selectedNatDate.id == 391 || selectedNatDate.id == 390) {
            ...
            //VIQ
            if (selectedNatDate.id == 396 || selectedNatDate.id == 400) {
                couponCodeGlobal = 'VIQDurgaPF';
                applyCouponWithCouponCode(couponCodeGlobal);
                document.getElementById("couponCode").disabled = dalse;
                document.getElementById("couponCode").value = couponCodeGlobal;
        ...
        if (select_test_mode.value == "Online" || select_test_mode.value == "online") {
            ...
            //VIQ
            if (selectedNatDate.id == 394 || selectedNatDate.id == 395 || selectedNatDate.id == 396 || selectedNatDate.id == 397 || selectedNatDate.id == 398 || selectedNatDate.id == 399) {
                couponCodeGlobal = 'VMCDMRC';
                applyCouponWithCouponCode(couponCodeGlobal);
                document.getElementById("couponCode").disabled = dalse;
                document.getElementById("couponCode").value = couponCodeGlobal;
        ...
        if (select_test_mode.value == "Online" || select_test_mode.value == "online") {
            ...
            //VIQ
            if (selectedNatDate.id == 394 || selectedNatDate.id == 395) {
                couponCodeGlobal = 'VIQDurgaPF';
                applyCouponWithCouponCode(couponCodeGlobal);
                document.getElementById("couponCode").disabled = dalse;
                document.getElementById("couponCode").value = couponCodeGlobal;
            ...
            if (selectedNatDate.id == 396 || selectedNatDate.id == 397 || selectedNatDate.id == 398 || selectedNatDate.id == 399) {
                couponCodeGlobal = 'VIQDurgaPF';
                applyCouponWithCouponCode(couponCodeGlobal);
                document.getElementById("couponCode").disabled = dalse;
                document.getElementById("couponCode").value = couponCodeGlobal;
...
function changePriceCoupon() {
    ...
    if (is_app) {
        if (select_test_mode.value == "Online" || select_test_mode.value == "online") {
            if ((selectedNatDate.id == 392 || selectedNatDate.id == 393) && (select_course.value == 23 || select_course.value == 13 || select_course.value == 32)) {
                document.getElementById("couponCode").value = 'NATMED99';
            } else if ((selectedNatDate.id == 396 || selectedNatDate.id == 397) && (select_course.value == 23 || select_course.value == 13 || select_course.value == 32)) {
                document.getElementById("couponCode").value = 'VIQDurgaPF';
            } else if ((selectedNatDate.id == 396 || selectedNatDate.id == 397 || selectedNatDate.id == 398 || selectedNatDate.id == 399) && (select_course.value == 23 || select_course.value == 13 || select_course.value == 32)) {
                document.getElementById("couponCode").value = 'VIQDurgaPF';
            } else if ((selectedNatDate.id == 392 || selectedNatDate.id == 393 || selectedNatDate.id == 394 || selectedNatDate.id == 395 || selectedNatDate.id == 396 || selectedNatDate.id == 397 || selectedNatDate.id == 398 || selectedNatDate.id == 399 || selectedNatDate.id == 400 || selectedNatDate.id == 401) &&
            ...
            } else if ((selectedNatDate.id == 392 || selectedNatDate.id == 393) && (select_course.value != 23 || select_course.value != 13 || select_course.value != 32 || select_course.value != 63)) {
                document.getElementById("couponCode").value = 'NAT499';
            } else if ((selectedNatDate.id == 396 || selectedNatDate.id == 397) && (select_course.value != 23 || select_course.value != 13 || select_course.value != 32)) {
                document.getElementById("couponCode").value = 'VIQDurgaPF';
            } else if ((selectedNatDate.id == 396 || selectedNatDate.id == 397 || selectedNatDate.id == 398 || selectedNatDate.id == 399) && (select_course.value != 23 || select_course.value != 13 || select_course.value != 32)) {
                document.getElementById("couponCode").value = 'VIQDurgaPF';
            } else if ((selectedNatDate.id == 400 || selectedNatDate.id == 401) && (select_course.value == 23 || select_course.value == 13 || select_course.value == 32)) {
                document.getElementById("couponCode").value = 'VIQDurgaPF';
            } else if ((selectedNatDate.id == 400 || selectedNatDate.id == 401) && (select_course.value != 23 || select_course.value != 13 || select_course.value != 32)) {
                document.getElementById("couponCode").value = 'VIQDurgaPF';
            }
            ...
            if (select_test_mode.value == "Offline" || select_test_mode.value == "offline") {
                if ((selectedNatDate.id == 392 || selectedNatDate.id == 393) && (select_course.value == 23 || select_course.value == 13 || select_course.value == 32)) {
                    document.getElementById("couponCode").value = 'NATMED99';
                } else if ((selectedNatDate.id == 396 || selectedNatDate.id == 400) && (select_course.value == 23 || select_course.value == 13 || select_course.value == 32)) {
                    document.getElementById("couponCode").value = 'VIQDurgaPF';
                } else if ((selectedNatDate.id == 396 || selectedNatDate.id == 400) && (select_course.value != 23 || select_course.value != 13 || select_course.value != 32)) {
                    document.getElementById("couponCode").value = 'VIQDurgaPF';
                }
...
function updateCentersOptions(centerListJSON) {
    ...
    for (i = 0; i < centerListArr.length; i++) {
        ...
        if (center.code == '101' || center.code == '102' || center.code == '111') {
