...
function natTestModeSelected() {
    ...
    var first = document.getElementById('select_test_mode'),
            second = document.getElementById('select_nat_date');
            if (select_test_mode.value == 'Online') {
...
$(function() {
    ...
    if (urlParams.has('exam_type')) {
        ...
        $(`[name="select_test_type"][value="6"]`).prop('checked', true);
        $('#viq_tab').trigger('click');
    }
...
function pageLoaded() {
    ...
    if (urlParams.has('special_link') && urlParams.get('special_link') != "") {
        if (urlParams.get('special_link') == "apj" || urlParams.get('special_link') == "APJ") {
            is_special = true;
            special_coupon = "VMCAPJ199";
        }
        if (urlParams.get('special_link') == "spring" || urlParams.get('special_link') == "SPRING") {
                is_special = true;
                special_coupon = "SpringSpl";
            }
