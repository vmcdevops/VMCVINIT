...
function pageLoaded() {
    ...
    if (urlParams.has('special_link') && urlParams.get('special_link') != "") {
        ...
        if ((urlParams.get('special_link') == "vmcpromo" || urlParams.get('special_link') == "VMCPROMO")) {
            is_special = true;
            special_coupon = "VMCPRO199";
        }


        if ((urlParams.get('special_link') == "vmcsplro99" || urlParams.get('special_link') == "VMCSPLRO99")) {
            is_special = true;
            special_coupon = "VMCSPLRO99";
        }
        if ((urlParams.get('special_link') == "gnsplnat99" || urlParams.get('special_link') == "GNSPLNAT99")) {
            is_special = true;
            special_coupon = "GNSPLNAT99";
        }

        if ((urlParams.get('special_link') == "jmdsplnat99" || urlParams.get('special_link') == "JMDSPLNAT99")) {
            is_special = true;
            special_coupon = "JMDSPLNAT99";
        }
    } else {
        is_special = true;
        special_coupon = "VMCPROMO99";
...
function startLeadProcessCourse(i) {
    ...
    var prdAPI = "https://vidyamandir.com/nat-national-admission-test-promo.html";
