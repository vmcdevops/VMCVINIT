...
function updateCentersOptions(centerListJSON) {
    ...
    for (i = 0; i < centerListArr.length; i++) {
        ...
        if (center.code == '101' || center.code == '102' || center.code == '103' || center.code == '104' || center.code == '105' || center.code == '106' || center.code == '107' || center.code == '108' || center.code == '109' || center.code == '110' || center.code == '111' || center.code == '112' || center.code == '113' || center.code == '114') {
