...
function changePriceCoupon() {
    ...
    if (is_app) {
        if (select_test_mode.value == "Online" || select_test_mode.value == "online") {
            if ((selectedNatDate.id == 392 || selectedNatDate.id == 393) && (select_course.value == 23 || select_course.value == 13 || select_course.value == 32)) {
            ...
            } else if ((selectedNatDate.id == 394 || selectedNatDate.id == 395) && (select_course.value == 23 || select_course.value == 13 || select_course.value == 32)) {
                ...
                document.getElementById("couponCode").value = 'VIQ499';
                //NATFOUNDATION0
                ...
                document.getElementById("couponCode").value = 'VIQ99';
            } else if ((selectedNatDate.id == 400 || selectedNatDate.id == 401) && (select_course.value != 23 || select_course.value != 13 || select_course.value != 32)) {
                document.getElementById("couponCode").value = 'VIQ499';
            }
...
function couponCodeAppliedSuccessfully() {
    ...
    let htmlInfo = '<img id="couponcode_status_img" width="20" height="20" alt="success" src="https://www.vidyamandir.com/img/coupon_apply_success.png"/><span id="couponcode_status_msg" style="margin-left:10px;font-size:12px;color:#000">Coupon code applied successfully.</span>';
