...
function natDateOptionSelected() {
    ...
    if (is_app) {
        if (select_test_mode.value == "Online" || select_test_mode.value == "online") {
            if (selectedNatDate.id == 346) {
                couponCodeGlobal = 'VINitpaytm399';
            ...
            if (selectedNatDate.id == 347) {
                couponCodeGlobal = 'VINitpaytm199';
                applyCouponWithCouponCode(couponCodeGlobal);
                document.getElementById("couponCode").disabled = dalse;
                document.getElementById("couponCode").value = couponCodeGlobal;
            }
            if (selectedNatDate.id == 348) {
                couponCodeGlobal = 'VINitpaytm299';
                applyCouponWithCouponCode(couponCodeGlobal);
                document.getElementById("couponCode").disabled = dalse;
                document.getElementById("couponCode").value = couponCodeGlobal;
            }
            if (selectedNatDate.id == 349) {
                couponCodeGlobal = 'VINitpaytm399';
                applyCouponWithCouponCode(couponCodeGlobal);
                document.getElementById("couponCode").disabled = dalse;
                document.getElementById("couponCode").value = couponCodeGlobal;
            }
            if (selectedNatDate.id == 350 || selectedNatDate.id == 351) {
                couponCodeGlobal = 'VINitpaytm399';
                applyCouponWithCouponCode(couponCodeGlobal);
                document.getElementById("couponCode").disabled = dalse;
                document.getElementById("couponCode").value = couponCodeGlobal;
        ...
        if (select_test_mode.value == "Online" || select_test_mode.value == "online") {
            ...
            if (selectedNatDate.id == 346) {
                couponCodeGlobal = 'VINitpaytm499';
                applyCouponWithCouponCode(couponCodeGlobal);
                document.getElementById("couponCode").disabled = dalse;
                document.getElementById("couponCode").value = couponCodeGlobal;
...
function changePriceCoupon() {
    ...
    if (is_app) {
        if (examType == 6) {
            if (select_test_mode.value == "Online" || select_test_mode.value == "online") {
                if ((selectedNatDate.id == 346 || selectedNatDate.id == 347 || selectedNatDate.id == 349 || selectedNatDate.id == 348) && (select_course.value == 23 || select_course.value == 13)) {
                    document.getElementById("couponCode").value = 'VINitpaytmMED99';
                } else if ((selectedNatDate.id == 346 || selectedNatDate.id == 347 || selectedNatDate.id == 349 || selectedNatDate.id == 348) &&
                    ...
                    document.getElementById("couponCode").value = 'VINitpaytm499';

                } else if ((selectedNatDate.id == 346 || selectedNatDate.id == 347 || selectedNatDate.id == 349 || selectedNatDate.id == 348) &&
                    (centre_code == 151 || centre_code == 152 || centre_code == 153 || centre_code == 195)) {
                    document.getElementById("couponCode").value = 'VINitpaytm299';

                } else if ((selectedNatDate.id == 350 || selectedNatDate.id == 351) &&
                    (centre_code == 151 || centre_code == 152 || centre_code == 153 || centre_code == 195)) {
                    document.getElementById("couponCode").value = 'VINitpaytm399';

                } else if ((selectedNatDate.id == 346) && (select_course.value != 23 || select_course.value != 13 || select_course.value != 62)) {
                    document.getElementById("couponCode").value = 'VINitpaytm399';
                } else if ((selectedNatDate.id == 347) && (select_course.value != 23 || select_course.value != 13 || select_course.value != 62)) {
                    document.getElementById("couponCode").value = 'VINitpaytm199';
                }else if ((selectedNatDate.id == 348) && (select_course.value != 23 || select_course.value != 13 || select_course.value != 62)) {
                    document.getElementById("couponCode").value = 'VINitpaytm299';
                } else if ((selectedNatDate.id == 349) && (select_course.value != 23 || select_course.value != 13 || select_course.value != 62)) {
                    document.getElementById("couponCode").value = 'VINitpaytm399';
                } 
                ...
                if (select_test_mode.value == "Offline" || select_test_mode.value == "offline") {
                    if (select_course.value == 23 || select_course.value == 13) {
                        document.getElementById("couponCode").value = 'VINitpaytmMED99';
                    } else if ((selectedNatDate.id == 346 || selectedNatDate.id == 349 || selectedNatDate.id == 350) &&
                        (centre_code == 151 || centre_code == 152 || centre_code == 153 || centre_code == 195)) {
                        document.getElementById("couponCode").value = 'VINitpaytm299';
                    } else if ((selectedNatDate.id == 346) && (select_course.value != 23 || select_course.value != 13)) {
                        document.getElementById("couponCode").value = 'VINitpaytm299';
                    } else if ((selectedNatDate.id == 349) && (select_course.value != 23 || select_course.value != 13)) {
                        document.getElementById("couponCode").value = 'VINitpaytm399';
                    } else {
...
function updateUIAsPerCartInfo() {
    ...
    if (isDiscount) {
        ...
        Couponlaodproce = 299;
        htmlInfo = '<span style="font-size: 14px; text-decoration: line-through; text-decoration-color: red;">&#8377 999</span><span style="font-size: 14px; margin-left: 10px;">&#8377 ' + Couponlaodproce + " Only</span>";
...
function getCartSuccess(responseText) {
    ...
    if (defaultCouponApplied == false) {
        ...
        if (is_app) {
            ...
            if (examType == 2) {
                document.getElementById("couponCode").value = `${TEST_TYPE}199`;
            }

            if (examType == 3) {
                document.getElementById("couponCode").value = 'VIQPLUS299';
            }
            if (examType == 6) {
                document.getElementById("couponCode").value = 'VINitpaytm299';
            }
...
function updateCentersOptions(centerListJSON) {
    ...
    /** Added By surendra  2023-09-19*/
    if (selectedCourse == 74 || selectedCourse == 64) {
        centerListArr.splice(0, 1);
        centerListArr.splice(0, 1);

    }

    /** Added By surendra  2023-11-25*/
    if (selectedDateTime == 'VMC VINIT 10 Dec 2023 10 AM - 1 PM' || selectedDateTime == 'VMC VINIT 10 Dec 2023 3 PM - 6 PM') {
        centerListArr = centerListArr.filter(centerListArr => centerListArr['code'] == '151' || centerListArr['code'] == '152' || centerListArr['code'] == '153' ||
            centerListArr['code'] == '114' || centerListArr['code'] == '116' || centerListArr['code'] == '119' || centerListArr['code'] == '126' || centerListArr['code'] == '129' || centerListArr['code'] == '137' ||
            centerListArr['code'] == '140' || centerListArr['code'] == '142' || centerListArr['code'] == '143' || centerListArr['code'] == '146' || centerListArr['code'] == '149' || centerListArr['code'] == '158' ||
            centerListArr['code'] == '171' || centerListArr['code'] == '168' || centerListArr['code'] == '999' || centerListArr['code'] == '187' || centerListArr['code'] == '165' || centerListArr['code'] == '115' ||
            centerListArr['code'] == '138' || centerListArr['code'] == '162' || centerListArr['code'] == '163' || centerListArr['code'] == '194');
    }
    /** Added By surendra  2023-11-25*/
