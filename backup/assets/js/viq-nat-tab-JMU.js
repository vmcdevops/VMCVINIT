...
function changePriceCoupon() {
    ...
    if (is_app) {
        ...
        if (examType == 3) {
            ...
            if (today <= limitDate2) {
                document.getElementById("couponCode").value = 'VIQJAM199';
            } else {
                //  document.getElementById("couponCode").value = 'VIQJAM0';
            }
            document.getElementById("btn_remove_coupon").disabled = true;
            applyCoupon();
        }
...
function prepareRegionOptionsSelection(regionList) {
    ...
    for (i = 0; i < regionList.length; i++) {
        ...
        if (region.name == 'Jammu and Kashmir') {
