...
function natDateOptionSelected() {
    ...
    if (is_app) {
        if (select_test_mode.value == "Online" || select_test_mode.value == "online") {
            ...
            if (selectedNatDate.id == 355) {
                couponCodeGlobal = 'NAT399';
                applyCouponWithCouponCode(couponCodeGlobal);
                document.getElementById("couponCode").disabled = dalse;
                document.getElementById("couponCode").value = couponCodeGlobal;
            }
            if (selectedNatDate.id == 356) {
                couponCodeGlobal = 'NAT399';
                applyCouponWithCouponCode(couponCodeGlobal);
                document.getElementById("couponCode").disabled = dalse;
                document.getElementById("couponCode").value = couponCodeGlobal;
...
function changePriceCoupon() {
    ...
    if (is_app) {
        if (examType == 2) {
            if (select_test_mode.value == "Online" || select_test_mode.value == "online") {
                if ((selectedNatDate.id == 354 || selectedNatDate.id == 355 || selectedNatDate.id == 356) && (select_course.value == 23 || select_course.value == 13)) {
                ...
                } else if ((selectedNatDate.id == 354) && (select_course.value != 23 || select_course.value != 13 || select_course.value != 62)) {
                    document.getElementById("couponCode").value = 'NAT399';
                } else if ((selectedNatDate.id == 355) && (select_course.value != 23 || select_course.value != 13 || select_course.value != 62)) {
                    document.getElementById("couponCode").value = 'NAT399';
                }else if ((selectedNatDate.id == 356) && (select_course.value != 23 || select_course.value != 13 || select_course.value != 62)) {
                    document.getElementById("couponCode").value = 'NAT399';
                }
                ...
                if (select_test_mode.value == "Offline" || select_test_mode.value == "offline") {
                    if (select_course.value == 23 || select_course.value == 13) {
                        document.getElementById("couponCode").value = 'NATMED99';
                    }else if ((selectedNatDate.id == 354) && (select_course.value != 23 || select_course.value != 13)) {
                        document.getElementById("couponCode").value = 'NATRSPL';
                    } else if ((selectedNatDate.id == 355) && (select_course.value != 23 || select_course.value != 13)) {
                        document.getElementById("couponCode").value = 'NATRSPL';
                    } 
                    else {
