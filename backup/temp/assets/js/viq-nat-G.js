...
function pageLoaded() {
    ...
    if (urlParams.has('special_link') && urlParams.get('special_link') != "") {
        ...
        if ((urlParams.get('special_link') == "vmcdav" || urlParams.get('special_link') == "VMCDAV")) {
            is_special = true;
            special_coupon = "VMCDAV";
        }
        if ((urlParams.get('special_link') == "99febspl" || urlParams.get('special_link') == "99FEBSPL")) {
            is_special = true;
            special_coupon = "99FEBSPL";
        }
