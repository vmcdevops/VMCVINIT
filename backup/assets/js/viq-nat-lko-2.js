...
function pageLoaded() {
    ...
    if (urlParams.has('special_link') && urlParams.get('special_link') != "") {
        ...
        if ((urlParams.get('special_link') == "lkosplnat99" || urlParams.get('special_link') == "LKOSPLNAT99")) {
            is_special = true;
            special_coupon = "LKOSPLNAT99";
        }
    }
...
function updateCentersOptions(centerListJSON) {
    ...
    for (i = 0; i < centerListArr.length; i++) {
        ...
        var option = document.createElement("option");
        if (center.code == '101' || center.code == '102' || center.code == '103' ||
            center.code == '104' || center.code == '105' || center.code == '106' ||
            center.code == '107' || center.code == '108' || center.code == '109' ||
            center.code == '110' || center.code == '111' || center.code == '112' ||
            center.code == '113' || center.code == '114' || center.code == '115' ||
            center.code == '116' || center.code == '119' || center.code == '120' ||
            center.code == '126' || center.code == '129' || center.code == '130' ||
            center.code == '132' || center.code == '137' || center.code == '138' ||
            center.code == '140' || center.code == '142' || center.code == '143' ||
            center.code == '140' || center.code == '142' || center.code == '143' ||
            center.code == '146' || center.code == '149' || center.code == '151' ||
            center.code == '152' || center.code == '153' || center.code == '158' ||
            center.code == '162' || center.code == '163' || center.code == '171' ||
            center.code == '168' || center.code == '173' || center.code == '999' ||
            center.code == '555' || center.code == '183' || center.code == '184' ||
            center.code == '185' || center.code == '187' || center.code == '188' ||
            center.code == '189' || center.code == '195' || center.code == '190' ||
            center.code == '191' || center.code == '192' || center.code == '193' ||
            center.code == '556' || center.code == '194'
        ) {
