...
function pageLoaded() {
    ...
    if (urlParams.has('special_link') && urlParams.get('special_link') != "") {
        ...
        if ((urlParams.get('special_link') == "spl199nat" || urlParams.get('special_link') == "SPL199NAT")) {
            is_special = true;
            special_coupon = "SPL199NAT";
        ...
        if ((urlParams.get('special_link') == "vgs99" || urlParams.get('special_link') == "VGS99")) {
            is_special = true;
            special_coupon = "VGS99";
        }
