...
function changePriceCoupon() {
    ...
    if (is_app) {
        if (examType == 2) {
            if (select_test_mode.value == "Online" || select_test_mode.value == "online") {
                if ((selectedNatDate.id == 359 || selectedNatDate.id == 360) && (select_course.value == 23 || select_course.value == 13 || select_course.value == 32)) {
                    document.getElementById("couponCode").value = 'NATMED99';
                } else if ((selectedNatDate.id == 359 || selectedNatDate.id == 360) && (select_course.value == 64 || select_course.value == 74 || select_course.value == 54)) {
                    document.getElementById("couponCode").value = 'NATFOUNDATION0';
                } else if ((selectedNatDate.id == 359 || selectedNatDate.id == 360) &&
                ...
                } else if ((selectedNatDate.id == 359) && (select_course.value != 23 || select_course.value != 13 || select_course.value != 62)) {
                    document.getElementById("couponCode").value = 'NAT299';
                } else if ((selectedNatDate.id == 360) && (select_course.value != 23 || select_course.value != 13 || select_course.value != 62)) {
                    document.getElementById("couponCode").value = 'NAT299';
                } else if ((selectedNatDate.id == 359) && (select_course.value != 23 || select_course.value != 13 || select_course.value != 62)) {
                    document.getElementById("couponCode").value = 'NAT299';
                }
                ...
                if (select_test_mode.value == "Offline" || select_test_mode.value == "offline") {
                    if (select_course.value == 23 || select_course.value == 13 || select_course.value == 32) {
                        document.getElementById("couponCode").value = 'NATMED99';
                    } else if ((selectedNatDate.id == 359 || selectedNatDate.id == 360) && (select_course.value == 64 || select_course.value == 74 || select_course.value == 54)) {
                        document.getElementById("couponCode").value = 'NATFOUNDATION0';
                    } else if ((selectedNatDate.id == 359) && (select_course.value != 23 || select_course.value != 13)) {
                        document.getElementById("couponCode").value = 'NAT99';
                    } else if ((selectedNatDate.id == 360) && (select_course.value != 23 || select_course.value != 13)) {
                        document.getElementById("couponCode").value = 'NAT99';
                    } else {
        ...
        if (select_test_mode.value == "Online" || select_test_mode.value == "online") {
            if ((selectedNatDate.id == 359 || selectedNatDate.id == 360) && (select_course.value == 23 || select_course.value == 13 || select_course.value == 32)) {
                ...
                document.getElementById("couponCode").value = 'NATFOUNDATION0';
            } else if ((selectedNatDate.id == 354 || selectedNatDate.id == 355 || selectedNatDate.id == 356) &&
                (centre_code == 176 || centre_code == 178 || centre_code == 121 || centre_code == 174 || centre_code == 177 || centre_code == 170 || centre_code == 127 || centre_code == 128 ||
                    centre_code == 134 || centre_code == 136 || centre_code == 169 || centre_code == 145 || centre_code == 147 || centre_code == 175 ||
                    centre_code == 182 || centre_code == 179 || centre_code == 180 || centre_code == 181 || centre_code == 154 || centre_code == 156 || centre_code == 155 ||
                    centre_code == 160 || centre_code == 164 || centre_code == 117 || centre_code == 123 || centre_code == 141 || centre_code == 144 || centre_code == 148 || centre_code == 150 ||
