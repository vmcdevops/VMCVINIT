...
function changePriceCoupon() {
    ...
    if (is_app) {
        ...
        if (examType == 3) {
            if (selectedNatDate.id == 326 || selectedNatDate.id == 327 || selectedNatDate.id == 328 || selectedNatDate.id == 329) {
              //  document.getElementById("couponCode").value = 'VIQN&NE299';
            } else {
               // document.getElementById("couponCode").value = 'VIQN&NE0';
