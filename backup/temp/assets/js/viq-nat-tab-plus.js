...
function natDateOptionSelected() {
    ...
    if (is_app) {
        if (select_test_mode.value == "Online" || select_test_mode.value == "online") {
            if (selectedNatDate.id == 341 || selectedNatDate.id == 343) {
                couponCodeGlobal = 'VIQPLUS199';
            ...
            if (selectedNatDate.id == 344) {
                couponCodeGlobal = 'VIQPLUS299';
                applyCouponWithCouponCode(couponCodeGlobal);
                document.getElementById("couponCode").disabled = dalse;
                document.getElementById("couponCode").value = couponCodeGlobal;
            }
            if (selectedNatDate.id == 345) {
                couponCodeGlobal = 'VIQPLUS399';
                applyCouponWithCouponCode(couponCodeGlobal);
                document.getElementById("couponCode").disabled = dalse;
                document.getElementById("couponCode").value = couponCodeGlobal;
            }
...
function changePriceCoupon() {
    ...
    if (is_app) {
        if (examType == 3) {
            if (select_test_mode.value == "Online" || select_test_mode.value == "online") {
                if ((selectedNatDate.id == 341 || selectedNatDate.id == 343 || selectedNatDate.id == 344 || selectedNatDate.id == 345) && (select_course.value == 23 || select_course.value == 13)) {
                    document.getElementById("couponCode").value = 'VIQPLUSMED99';
                } else if ((selectedNatDate.id == 341 || selectedNatDate.id == 343 || selectedNatDate.id == 344 || selectedNatDate.id == 345) &&
                    ...
                    document.getElementById("couponCode").value = 'VIQPLUS499';
                } else if ((selectedNatDate.id == 341 || selectedNatDate.id == 343) && (select_course.value != 23 || select_course.value != 13 || select_course.value != 62)) {
                    document.getElementById("couponCode").value = 'VIQPLUS199';
                } else if ((selectedNatDate.id == 344) && (select_course.value != 23 || select_course.value != 13 || select_course.value != 62)) {
                    document.getElementById("couponCode").value = 'VIQPLUS299';
                } else if ((selectedNatDate.id == 345) && (select_course.value != 23 || select_course.value != 13 || select_course.value != 62)) {
                    document.getElementById("couponCode").value = 'VIQPLUS399';
                }
