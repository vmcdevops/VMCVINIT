...
function natDateOptionSelected() {
    ...
    if (is_app) {
        ...
        if (select_test_mode.value == "Online" || select_test_mode.value == "online") {
            ...
            if (selectedNatDate.id == 365 || selectedNatDate.id == 366 || selectedNatDate.id == 367) {
                couponCodeGlobal = 'NAT499';
                applyCouponWithCouponCode(couponCodeGlobal);
                document.getElementById("couponCode").disabled = dalse;
                document.getElementById("couponCode").value = couponCodeGlobal;
...
function changePriceCoupon() {
    ...
    if (is_app) {
        if (examType == 2) {
            if (select_test_mode.value == "Online" || select_test_mode.value == "online") {
                if ((selectedNatDate.id == 362 || selectedNatDate.id == 363 || selectedNatDate.id == 365 || selectedNatDate.id == 366 || selectedNatDate.id == 367) && (select_course.value == 23 || select_course.value == 13 || select_course.value == 32 || select_course.value == 63)) {
                    document.getElementById("couponCode").value = 'NATMED99';
                } else if ((selectedNatDate.id == 362 || selectedNatDate.id == 363 || selectedNatDate.id == 365 || selectedNatDate.id == 366 || selectedNatDate.id == 367) &&
                    ...
                    document.getElementById("couponCode").value = 'NAT499';
                } else if ((selectedNatDate.id == 365 || selectedNatDate.id == 366 || selectedNatDate.id == 367) && (select_course.value != 23 || select_course.value != 13 || select_course.value != 32 || select_course.value != 63)) {
                    document.getElementById("couponCode").value = 'NAT499';
                }  
                ...
                if (select_test_mode.value == "Offline" || select_test_mode.value == "offline") {
                    ...
                    } else if ((selectedNatDate.id == 364 || selectedNatDate.id == 365 || selectedNatDate.id == 367) && (select_course.value != 23 || select_course.value != 13 || select_course.value != 32 || select_course.value != 63)) {
                        document.getElementById("couponCode").value = 'NAT199';
                    } else {
