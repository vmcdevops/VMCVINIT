...
function natDateOptionSelected() {
    ...
    if (is_app) {
        if (select_test_mode.value == "Online" || select_test_mode.value == "online") {
            if (selectedNatDate.id == 367 || selectedNatDate.id == 368) {
                couponCodeGlobal = 'NATSO499';
            ...
            if (selectedNatDate.id == 370 || selectedNatDate.id == 371 || selectedNatDate.id == 372) {
                couponCodeGlobal = 'NATSO499';
                applyCouponWithCouponCode(couponCodeGlobal);
                document.getElementById("couponCode").disabled = dalse;
                document.getElementById("couponCode").value = couponCodeGlobal;
        ...
        if (select_test_mode.value == "Offline" || select_test_mode.value == "offline") {
            ...
            if (selectedNatDate.id == 370 || selectedNatDate.id == 371) {
                couponCodeGlobal = 'NAT199';
                applyCouponWithCouponCode(couponCodeGlobal);
                document.getElementById("couponCode").disabled = dalse;
                document.getElementById("couponCode").value = couponCodeGlobal;
        ...
        if (select_test_mode.value == "Online" || select_test_mode.value == "online") {
            ...
            if (selectedNatDate.id == 369 || selectedNatDate.id == 370 || selectedNatDate.id == 371 || selectedNatDate.id == 372) {
                couponCodeGlobal = 'VMCDMRC';
                applyCouponWithCouponCode(couponCodeGlobal);
                document.getElementById("couponCode").disabled = dalse;
                document.getElementById("couponCode").value = couponCodeGlobal;
...
function changePriceCoupon() {
    ...
    if (is_app) {
        if (examType == 2) {
            if (select_test_mode.value == "Online" || select_test_mode.value == "online") {
                if ((selectedNatDate.id == 367 || selectedNatDate.id == 368 || selectedNatDate.id == 369 || selectedNatDate.id == 370 || selectedNatDate.id == 371 || selectedNatDate.id == 372) && (select_course.value == 23 || select_course.value == 13 || select_course.value == 32 || select_course.value == 63)) {
                    document.getElementById("couponCode").value = 'NATMED99';
                } else if ((selectedNatDate.id == 367 || selectedNatDate.id == 368 || selectedNatDate.id == 369 || selectedNatDate.id == 370 || selectedNatDate.id == 371 || selectedNatDate.id == 372) &&
                    ...
                    document.getElementById("couponCode").value = 'NATSO499';
                    //NATFOUNDATION0

                } else if ((selectedNatDate.id == 367 || selectedNatDate.id == 368 || selectedNatDate.id == 369) && (select_course.value != 23 || select_course.value != 13 || select_course.value != 32 || select_course.value != 63)) {
                    document.getElementById("couponCode").value = 'NATSO499';
                } else if ((selectedNatDate.id == 370 || selectedNatDate.id == 371 || selectedNatDate.id == 372) && (select_course.value != 23 || select_course.value != 13 || select_course.value != 32 || select_course.value != 63)) {
                    document.getElementById("couponCode").value = 'NATSO499';
                }
                ...
                if (select_test_mode.value == "Offline" || select_test_mode.value == "offline") {
                    if (select_course.value == 23 || select_course.value == 13 || select_course.value == 32 || select_course.value == 63) {
                        document.getElementById("couponCode").value = 'NATMED99';
                    } else if ((selectedNatDate.id == 367 || selectedNatDate.id == 368 || selectedNatDate.id == 370 || selectedNatDate.id == 371) && (select_course.value != 23 || select_course.value != 13 || select_course.value != 32 || select_course.value != 63)) {
        ...
        if (examType == 2) {
            if (select_test_mode.value == "Online" || select_test_mode.value == "online") {
                ...
                } else if ((selectedNatDate.id == 367 || selectedNatDate.id == 368 || selectedNatDate.id == 369 || selectedNatDate.id == 370 || selectedNatDate.id == 371 || selectedNatDate.id == 372) && (select_course.value != 23 || select_course.value != 13 || select_course.value != 32 || select_course.value != 63)) {
                    document.getElementById("couponCode").value = 'VMCDMRC';
                } else if ((selectedNatDate.id == 367 || selectedNatDate.id == 368 || selectedNatDate.id == 369 || selectedNatDate.id == 370 || selectedNatDate.id == 371 || selectedNatDate.id == 372) && (select_course.value != 23 || select_course.value != 13 || select_course.value != 32 || select_course.value != 63)) {
                    document.getElementById("couponCode").value = 'VMCDMRC';
                }
