...
function natDateOptionSelected() {
    ...
    if (is_app) {
        if (select_test_mode.value == "Online" || select_test_mode.value == "online") {
            ...
            if (selectedNatDate.id == 392 || selectedNatDate.id == 393) {
...
function changePriceCoupon() {
    ...
    if (is_app) {
        if (examType == 2) {
            if (select_test_mode.value == "Online" || select_test_mode.value == "online") {
                if ((selectedNatDate.id == 391 || selectedNatDate.id == 392 || selectedNatDate.id == 393) && (select_course.value == 23 || select_course.value == 13 || select_course.value == 32 || select_course.value == 63)) {
                    document.getElementById("couponCode").value = 'NATMED99';
                } else if ((selectedNatDate.id == 391 || selectedNatDate.id == 392 || selectedNatDate.id == 393) &&
                ...
                } else if ((selectedNatDate.id == 391 || selectedNatDate.id == 392 || selectedNatDate.id == 393) && (select_course.value != 23 || select_course.value != 13 || select_course.value != 32 || select_course.value != 63)) {
                    document.getElementById("couponCode").value = 'NAT499';
        ...
        if (select_test_mode.value == "Online" || select_test_mode.value == "online") {
            if ((selectedNatDate.id == 391 || selectedNatDate.id == 392 || selectedNatDate.id == 393) && (select_course.value == 23 || select_course.value == 13 || select_course.value == 63 || select_course.value == 32)) {
                document.getElementById("couponCode").value = 'NATMED99';
            } else if ((selectedNatDate.id == 391 || selectedNatDate.id == 392 || selectedNatDate.id == 393) &&
                (centre_code == 176 || centre_code == 178 || centre_code == 121 || centre_code == 174 || centre_code == 177 || centre_code == 170 || centre_code == 127 || centre_code == 128 ||
                    centre_code == 134 || centre_code == 136 || centre_code == 169 || centre_code == 145 || centre_code == 147 || centre_code == 175 ||
