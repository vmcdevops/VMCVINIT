...
function natDateOptionSelected() {
    ...
    if(selectedNatDate.id == 304 || selectedNatDate.id == 305)
    {  
    couponCodeGlobal = 'VMCNAT99';
...
function startLeadProcessCourse(i) {
    ...
    var mobileNumber = document.getElementById("mobile"+i).value.trim();
		...
		var prdAPI= "https://vidyamandir.com/nat-national-admission-test-CD.html";
