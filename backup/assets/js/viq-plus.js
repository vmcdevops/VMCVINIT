...
function natDateOptionSelected() {
    ...
    if (is_app) {
        if (select_test_mode.value == "Online" || select_test_mode.value == "online") {
            //VIQ+
            if (selectedNatDate.id == 400 || selectedNatDate.id == 401 || selectedNatDate.id == 421 ||
                selectedNatDate.id == 422 || selectedNatDate.id == 423 || selectedNatDate.id == 425 || selectedNatDate.id == 426) {
                couponCodeGlobal = 'VIQPLUS99';
        ...
        if (select_test_mode.value == "Offline" || select_test_mode.value == "offline") {
            //VIQ+
            if (selectedNatDate.id == 396 || selectedNatDate.id == 400 || selectedNatDate.id == 421 ||
                selectedNatDate.id == 424 || selectedNatDate.id == 425) {
                couponCodeGlobal = 'VIQPLUS49';
                applyCouponWithCouponCode(couponCodeGlobal);
                document.getElementById("couponCode").disabled = dalse;
                document.getElementById("couponCode").value = couponCodeGlobal;
            }
