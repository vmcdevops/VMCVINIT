...
function natDateOptionSelected() {
    ...
    if (select_test_mode.value == "Online" || select_test_mode.value == "online") {
        if (selectedNatDate.id == 323 || selectedNatDate.id == 325) {
        ...
        if (selectedNatDate.id == 334 || selectedNatDate.id == 335 || selectedNatDate.id == 336 || selectedNatDate.id == 337 || selectedNatDate.id == 338 || selectedNatDate.id == 339) {
            couponCodeGlobal = 'VIQMSIL99';
            applyCouponWithCouponCode(couponCodeGlobal);
            document.getElementById("couponCode").disabled = dalse;
            document.getElementById("couponCode").value = couponCodeGlobal;

        }
        if (selectedNatDate.id == 322 || selectedNatDate.id == 324) {
            couponCodeGlobal = 'VIQMSIL99';
            applyCouponWithCouponCode(couponCodeGlobal);
            document.getElementById("couponCode").disabled = dalse;
            document.getElementById("couponCode").value = couponCodeGlobal;
    ...
    if (select_test_mode.value == "Offline" || select_test_mode.value == "offline") {
        if (selectedNatDate.id == 322) {
            couponCodeGlobal = 'VIQ999';
            applyCouponWithCouponCode(couponCodeGlobal);
            document.getElementById("couponCode").disabled = dalse;
            document.getElementById("couponCode").value = couponCodeGlobal;
        }
...
function changePriceCoupon() {
    ...
    if (is_app) {
        if (examType == 3) {
            if (select_test_mode.value == "Online" || select_test_mode.value == "online") {
                if ((selectedNatDate.id == 323 || selectedNatDate.id == 325 || selectedNatDate.id == 327 || selectedNatDate.id == 329) && (select_course.value == 23 || select_course.value == 13)) {
                    document.getElementById("couponCode").value = 'VIQMSIL99';
                } else if ((selectedNatDate.id == 334 || selectedNatDate.id == 335 || selectedNatDate.id == 336 || selectedNatDate.id == 337 || selectedNatDate.id == 338 || selectedNatDate.id == 339) && (select_course.value == 23 || select_course.value == 13)) {
                    document.getElementById("couponCode").value = 'VIQMSIL99';
                } else if ((selectedNatDate.id == 322 || selectedNatDate.id == 323 || selectedNatDate.id == 324 || selectedNatDate.id == 325 || selectedNatDate.id == 326 || selectedNatDate.id == 327 || selectedNatDate.id == 328 || selectedNatDate.id == 329 || selectedNatDate.id == 334 || selectedNatDate.id == 335 || selectedNatDate.id == 336 || selectedNatDate.id == 337 || selectedNatDate.id == 338 || selectedNatDate.id == 339) && (select_course.value == 62)) {
                    document.getElementById("couponCode").value = 'VIQCUET99';
                } else if ((selectedNatDate.id == 334 || selectedNatDate.id == 335 || selectedNatDate.id == 336 || selectedNatDate.id == 337 || selectedNatDate.id == 338 || selectedNatDate.id == 339) && (select_course.value != 23 || select_course.value != 13 || select_course.value != 62)) {
                    document.getElementById("couponCode").value = 'VIQ0';
                } else if ((selectedNatDate.id == 323 || selectedNatDate.id == 325) && (select_course.value != 23 || select_course.value != 13 || select_course.value != 62)) {
                    document.getElementById("couponCode").value = 'VIQMSIL99';
                } else if ((selectedNatDate.id == 326 || selectedNatDate.id == 327 || selectedNatDate.id == 328 || selectedNatDate.id == 329) && (select_course.value != 23 || select_course.value != 13 || select_course.value != 62)) {
                    document.getElementById("couponCode").value = 'VIQMSIL99';
                } else if ((selectedNatDate.id == 322 || selectedNatDate.id == 324) && (select_course.value != 23 || select_course.value != 13 || select_course.value != 62)) {
                    document.getElementById("couponCode").value = 'VIQMSIL99';
                }
            } else {
                if (select_test_mode.value == "Offline" || select_test_mode.value == "offline") {
                    if (( selectedNatDate.id == 322 || selectedNatDate.id == 324) && (select_course.value == 23 || select_course.value == 13)) {
                        document.getElementById("couponCode").value = 'VIQ999';
                    } else if ((selectedNatDate.id == 322 || selectedNatDate.id == 324) && (select_course.value != 23 || select_course.value != 13)) {
                        document.getElementById("couponCode").value = 'VIQ999';
                    } else {
        ...
        if (select_test_mode.value == "Online" || select_test_mode.value == "online") {
            if ((selectedNatDate.id == 323 || selectedNatDate.id == 325 || selectedNatDate.id == 327 || selectedNatDate.id == 329) && (select_course.value == 23 || select_course.value == 13)) {
                ...
                document.getElementById("couponCode").value = 'VIQMSIL99';
            } else if ((selectedNatDate.id == 322 || selectedNatDate.id == 323 || selectedNatDate.id == 324 || selectedNatDate.id == 325 ||
                    selectedNatDate.id == 326 || selectedNatDate.id == 327 || selectedNatDate.id == 328 || selectedNatDate.id == 329 ||
                    selectedNatDate.id == 334 || selectedNatDate.id == 335 || selectedNatDate.id == 336 || selectedNatDate.id == 337 || selectedNatDate.id == 338 || selectedNatDate.id == 339) &&
