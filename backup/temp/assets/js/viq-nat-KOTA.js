...
function prepareNatDateOptionsSelection(natDatesList) {
    ...
    for (i = 0; i < natDatesList.length; i++) {
        ...
        if (natDate.testDate == '2023-10-07' || natDate.testDate == '2023-10-08') {
...
function getCartSuccess(responseText) {
    ...
    if (defaultCouponApplied == false) {
        ...
        if (is_app) {
            ...
            if (examType == 3) {
                document.getElementById("couponCode").value = "VIQKOT99";
            }
            /*if (examType == 2) {
             document.getElementById("couponCode").value = couponCodeGlobal;
            } else {
...
function updateContactUserDetails() {
    ...
    // alert("radhe");
    // alert(preferedTestDateId);
    //alert(document.getElementById("select_nat_date").text);
    //alert(selectedNatDate.testDate);
    var json = {
        params: {
            firstName: firstName,
            lastName: lastName,
