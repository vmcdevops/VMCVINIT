...
function updateUIAsPerCartInfo() {
    ...
    if(isDiscount) {
        htmlInfo = '<span style="font-size: 22px; text-decoration: line-through; text-decoration-color: red;">&#8377 500</span><span style="font-size: 22px; margin-left: 20px;">&#8377 '+ userCartSummery.total_amount +' Only</span>';
    } else {
        htmlInfo = '<span style="font-size: 22px; margin-left: 20px;">&#8377 '+ userCartSummery.total_amount +' Only</span>';
    }
...
function registerGuestUserForPurchase() {
