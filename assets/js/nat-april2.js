...
function natDateOptionSelected() {
    ...
    if (is_app) {
        if (select_test_mode.value == "Online" || select_test_mode.value == "online") {
            ...
            if (selectedNatDate.id == 382 || selectedNatDate.id == 383 || selectedNatDate.id == 384 || selectedNatDate.id == 385 || selectedNatDate.id == 387) {
                couponCodeGlobal = 'NAT299';
                applyCouponWithCouponCode(couponCodeGlobal);
                document.getElementById("couponCode").disabled = dalse;
                document.getElementById("couponCode").value = couponCodeGlobal;
            }
        ...
        if (select_test_mode.value == "Offline" || select_test_mode.value == "offline") {
            if (selectedNatDate.id == 381 || selectedNatDate.id == 383 || selectedNatDate.id == 384 || selectedNatDate.id == 389 ) {
        ...
        if (select_test_mode.value == "Online" || select_test_mode.value == "online") {
            ...
            if (selectedNatDate.id == 382 || selectedNatDate.id == 383 || selectedNatDate.id == 384 || selectedNatDate.id == 389) {
                couponCodeGlobal = 'VMCDMRC';
                applyCouponWithCouponCode(couponCodeGlobal);
                document.getElementById("couponCode").disabled = dalse;
                document.getElementById("couponCode").value = couponCodeGlobal;
...
function changePriceCoupon() {
    ...
    if (is_app) {
        if (examType == 2) {
            if (select_test_mode.value == "Online" || select_test_mode.value == "online") {
                if ((selectedNatDate.id == 381 || selectedNatDate.id == 382 || selectedNatDate.id == 383 || selectedNatDate.id == 384 || selectedNatDate.id == 385 || selectedNatDate.id == 387 || selectedNatDate.id == 389) && (select_course.value == 23 || select_course.value == 13 || select_course.value == 32 || select_course.value == 63)) {
                    ...
                    document.getElementById("couponCode").value = 'NAT499';
                } else if ((selectedNatDate.id == 382 || selectedNatDate.id == 383 || selectedNatDate.id == 384 || selectedNatDate.id == 385 || selectedNatDate.id == 387 || selectedNatDate.id == 389) && (select_course.value != 23 || select_course.value != 13 || select_course.value != 32 || select_course.value != 63)) {
                    document.getElementById("couponCode").value = 'NAT499';
                }
        ...
        if (select_test_mode.value == "Online" || select_test_mode.value == "online") {
            if ((selectedNatDate.id == 381 || selectedNatDate.id == 382 || selectedNatDate.id == 383 || selectedNatDate.id == 384 || selectedNatDate.id == 385 || selectedNatDate.id == 387 || selectedNatDate.id == 389) && (select_course.value == 23 || select_course.value == 13 || select_course.value == 63)) {
                document.getElementById("couponCode").value = 'NATMED99';
            } else if ((selectedNatDate.id == 381 || selectedNatDate.id == 382 || selectedNatDate.id == 383 || selectedNatDate.id == 384 || selectedNatDate.id == 389) &&
                (centre_code == 176 || centre_code == 178 || centre_code == 121 || centre_code == 174 || centre_code == 177 || centre_code == 170 || centre_code == 127 || centre_code == 128 ||
                    centre_code == 134 || centre_code == 136 || centre_code == 169 || centre_code == 145 || centre_code == 147 || centre_code == 175 ||
            ...
            if (select_test_mode.value == "Offline" || select_test_mode.value == "offline") {
                if (select_course.value == 23 || select_course.value == 13 || select_course.value == 32 || select_course.value == 63) {
                    document.getElementById("couponCode").value = 'NATMED99';
                } else if ((selectedNatDate.id == 381 || selectedNatDate.id == 387) && (select_course.value != 23 || select_course.value != 13 || select_course.value != 32 || select_course.value != 63)) {
                    document.getElementById("couponCode").value = 'NAT199';
                } else if ((selectedNatDate.id == 381 || selectedNatDate.id == 382 || selectedNatDate.id == 383 || selectedNatDate.id == 384 || selectedNatDate.id == 387) && (select_course.value != 23 || select_course.value != 13 || select_course.value != 32 || select_course.value != 63)) {
                    document.getElementById("couponCode").value = 'NAT199';
                } else {
                    //document.getElementById("couponCode").value = 'VIQ999';
                }
...
function getCartSuccess(responseText) {
    ...
    if (defaultCouponApplied == false) {
        ...
        if (is_app) {
            ...
            document.getElementById("couponCode").value = 'NAT299';
