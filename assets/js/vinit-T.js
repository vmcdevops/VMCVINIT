...
function natDateOptionSelected() {
    ...
    if (is_app) {
        if (select_test_mode.value == "Online" || select_test_mode.value == "online") {
            if (selectedNatDate.id == 346 || selectedNatDate.id == 347) {
                couponCodeGlobal = 'VINit299';
        ...
        if (examType == 6) {
            if (select_test_mode.value == "Online" || select_test_mode.value == "online") {
                if ((selectedNatDate.id == 346 || selectedNatDate.id == 347 || selectedNatDate.id == 349 || selectedNatDate.id == 348) && (select_course.value == 23 || select_course.value == 13)) {
                    document.getElementById("couponCode").value = 'VINitMED99';
                    ...
                    document.getElementById("couponCode").value = 'VINit499';
                    
                }else if ((selectedNatDate.id == 346 || selectedNatDate.id == 347 || selectedNatDate.id == 349 || selectedNatDate.id == 348) &&
                (centre_code == 151 || centre_code == 152 || centre_code == 153 || centre_code == 195)) {
                document.getElementById("couponCode").value = 'VINit299'; 
                
                }else if ((selectedNatDate.id == 350 || selectedNatDate.id == 351) &&
                (centre_code == 151 || centre_code == 152 || centre_code == 153 || centre_code == 195)) {
                document.getElementById("couponCode").value = 'VINit399'; 
                
                } else if ((selectedNatDate.id == 346 || selectedNatDate.id == 347) && (select_course.value != 23 || select_course.value != 13 || select_course.value != 62)) {
                    document.getElementById("couponCode").value = 'VINit199';
