...
function natDateOptionSelected() {
    ...
    if (is_app) {
        ...
        if (select_test_mode.value == "Offline" || select_test_mode.value == "offline") {
            if (selectedNatDate.id == 381 || selectedNatDate.id == 383 || selectedNatDate.id == 384 || selectedNatDate.id == 389 || selectedNatDate.id == 390) {
        ...
        if (select_test_mode.value == "Online" || select_test_mode.value == "online") {
            ...
            if (selectedNatDate.id == 382 || selectedNatDate.id == 383 || selectedNatDate.id == 384 || selectedNatDate.id == 389 || selectedNatDate.id == 390) {
                couponCodeGlobal = 'VMCDMRC';
                applyCouponWithCouponCode(couponCodeGlobal);
                document.getElementById("couponCode").disabled = dalse;
                document.getElementById("couponCode").value = couponCodeGlobal;
...
function changePriceCoupon() {
    ...
    if (is_app) {
        if (examType == 2) {
            if (select_test_mode.value == "Online" || select_test_mode.value == "online") {
                if ((selectedNatDate.id == 381 || selectedNatDate.id == 382 || selectedNatDate.id == 383 || selectedNatDate.id == 384 || selectedNatDate.id == 385 || selectedNatDate.id == 387 || selectedNatDate.id == 389 || selectedNatDate.id == 390) && (select_course.value == 23 || select_course.value == 13 || select_course.value == 32 || select_course.value == 63)) {
                    document.getElementById("couponCode").value = 'VMCs49';
                } else if ((selectedNatDate.id == 381 || selectedNatDate.id == 382 || selectedNatDate.id == 383 || selectedNatDate.id == 384 || selectedNatDate.id == 385 || selectedNatDate.id == 389) &&
                ...
                } else if ((selectedNatDate.id == 381 || selectedNatDate.id == 385 || selectedNatDate.id == 389) && (select_course.value != 23 || select_course.value != 13 || select_course.value != 32 || select_course.value != 63)) {
                    document.getElementById("couponCode").value = 'VMCs49';
                ...
                if (select_test_mode.value == "Offline" || select_test_mode.value == "offline") {
                    if (select_course.value == 23 || select_course.value == 13 || select_course.value == 32 || select_course.value == 63 ) {
                        document.getElementById("couponCode").value = 'VMCs49';
                    } else if ((selectedNatDate.id == 381 || selectedNatDate.id == 387 || selectedNatDate.id == 389) && (select_course.value != 23 || select_course.value != 13 || select_course.value != 32 || select_course.value != 63)) {
                        document.getElementById("couponCode").value = 'NAT199';
                    } else if ((selectedNatDate.id == 382 || selectedNatDate.id == 383 || selectedNatDate.id == 384 || selectedNatDate.id == 387 || selectedNatDate.id == 389 ) && (select_course.value != 23 || select_course.value != 13 || select_course.value != 32 || select_course.value != 63)) {
                        document.getElementById("couponCode").value = 'NAT199';
                    } else {
        ...
        if (examType == 2) {
            if (select_test_mode.value == "Online" || select_test_mode.value == "online") {
                if ((selectedNatDate.id == 381 || selectedNatDate.id == 382 || selectedNatDate.id == 383 || selectedNatDate.id == 384 || selectedNatDate.id == 389) && (select_course.value == 23 || select_course.value == 13 || select_course.value == 32 || select_course.value == 63)) {
                    document.getElementById("couponCode").value = 'VMCDMRC';
                } else if ((selectedNatDate.id == 381 || selectedNatDate.id == 382 || selectedNatDate.id == 383 || selectedNatDate.id == 384 || selectedNatDate.id == 389) &&
                    (centre_code == 176 || centre_code == 178 || centre_code == 121 || centre_code == 174 || centre_code == 177 || centre_code == 170 || centre_code == 127 || centre_code == 128 ||
                        centre_code == 134 || centre_code == 136 || centre_code == 169 || centre_code == 145 || centre_code == 147 || centre_code == 175 ||
                        centre_code == 182 || centre_code == 179 || centre_code == 180 || centre_code == 181 || centre_code == 154 || centre_code == 156 || centre_code == 155 ||
                        centre_code == 160 || centre_code == 164 || centre_code == 117 || centre_code == 123 || centre_code == 141 || centre_code == 144 || centre_code == 148 || centre_code == 150 ||
        ...
        if (select_test_mode.value == "Online" || select_test_mode.value == "online") {
            if ((selectedNatDate.id == 381 || selectedNatDate.id == 382 || selectedNatDate.id == 383 || selectedNatDate.id == 384 || selectedNatDate.id == 385 || selectedNatDate.id == 387 || selectedNatDate.id == 389 || selectedNatDate.id == 390) && (select_course.value == 23 || select_course.value == 13 || select_course.value == 63 || select_course.value == 32)) {
                document.getElementById("couponCode").value = 'VMCs49';
            } else if ((selectedNatDate.id == 381 || selectedNatDate.id == 382 || selectedNatDate.id == 383 || selectedNatDate.id == 384 || selectedNatDate.id == 389) &&
                (centre_code == 176 || centre_code == 178 || centre_code == 121 || centre_code == 174 || centre_code == 177 || centre_code == 170 || centre_code == 127 || centre_code == 128 ||
                    centre_code == 134 || centre_code == 136 || centre_code == 169 || centre_code == 145 || centre_code == 147 || centre_code == 175 ||
                ...
                document.getElementById("couponCode").value = 'VMCs49';
            } else if ((selectedNatDate.id == 381 || selectedNatDate.id == 382 || selectedNatDate.id == 383 || selectedNatDate.id == 384 || selectedNatDate.id == 385 || selectedNatDate.id == 387 || selectedNatDate.id == 389) && (select_course.value != 23 || select_course.value != 13 || select_course.value != 32 || select_course.value != 63)) {
                document.getElementById("couponCode").value = 'VMCs49';
            }
            ...
            if (select_test_mode.value == "Offline" || select_test_mode.value == "offline") {
                if (select_course.value == 23 || select_course.value == 13 || select_course.value == 32 || select_course.value == 63) {
                    document.getElementById("couponCode").value = 'VMCs49';
                } else if ((selectedNatDate.id == 381 || selectedNatDate.id == 387 || selectedNatDate.id == 389 || selectedNatDate.id == 390) && (select_course.value != 23 || select_course.value != 13 || select_course.value != 32 || select_course.value != 63)) {
                    document.getElementById("couponCode").value = 'NAT199';
