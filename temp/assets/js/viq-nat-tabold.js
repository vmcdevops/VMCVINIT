...
function changePriceCoupon() {
    ...
    if (is_app) {
        ...
        if ((selectedNatDate.id == 324 || selectedNatDate.id == 328) && (select_course.value != 62)) {
            document.getElementById("couponCode").value = `${TEST_TYPE}499`;
        } else {
            document.getElementById("couponCode").value = `${TEST_TYPE}499`;
        }
        ...
        document.getElementById("btn_remove_coupon").disabled = true;
        applyCoupon();
    } else if ((select_test_mode.value == "Online" || select_test_mode.value == "online") && (select_course.value == 62)) {
        document.getElementById("couponCode").value = 'VIQCUET0';
        document.getElementById("btn_remove_coupon").disabled = true;
        applyCoupon();
    } else {
