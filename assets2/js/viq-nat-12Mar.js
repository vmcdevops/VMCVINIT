...
function pageLoaded() {
    ...
    if (urlParams.has('special_link') && urlParams.get('special_link') != "") {
        ...
        if ((urlParams.get('special_link') == "vmcvinitonline499" || urlParams.get('special_link') == "VMCVINITONLINE499")) {
            is_special = true;
            special_coupon = "VMCVINITONLINE499";
        }

        if ((urlParams.get('special_link') == "camvmc" || urlParams.get('special_link') == "CAMVMC")) {
            is_special = true;
            special_coupon = "CAMVMC";
        }

        if ((urlParams.get('special_link') == "davvmc" || urlParams.get('special_link') == "DAVVMC")) {
            is_special = true;
            special_coupon = "DAVVMC";
        }

        if ((urlParams.get('special_link') == "vmcvinit49" || urlParams.get('special_link') == "VMCVINIT49")) {
            is_special = true;
            special_coupon = "VMCVINIT49";
        }

        if ((urlParams.get('special_link') == "vgsvmc" || urlParams.get('special_link') == "VGSVMC")) {
            is_special = true;
            special_coupon = "VGSVMC";
        }
        if ((urlParams.get('special_link') == "patsplvmc" || urlParams.get('special_link') == "PATSPLVMC")) {
            is_special = true;
            special_coupon = "PATSPLVMC";
        }
        if ((urlParams.get('special_link') == "millschsplnat99" || urlParams.get('special_link') == "MILLSCHSPLNAT99")) {
            is_special = true;
            special_coupon = "MILLSCHSPLNAT99";
        }

        if ((urlParams.get('special_link') == "vmcsplnat199" || urlParams.get('special_link') == "VMCSPLNAT199")) {
            is_special = true;
            special_coupon = "VMCSPLNAT199";
        }
        if ((urlParams.get('special_link') == "vmcsplnat99" || urlParams.get('special_link') == "VMCSPLNAT99")) {
            is_special = true;
            special_coupon = "VMCSPLNAT99";
        }
        if ((urlParams.get('special_link') == "vmcsplnatagra" || urlParams.get('special_link') == "VMCSPLNATAGRA")) {
            is_special = true;
            special_coupon = "VMCSPLNATAGRA";
        }
    }
