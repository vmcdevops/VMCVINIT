...
function natDateOptionSelected() {
    ...
    if (is_app) {
        if (select_test_mode.value == "Online" || select_test_mode.value == "online") {
            ...
            if (selectedNatDate.id == 378 || selectedNatDate.id == 379) {
...
function changePriceCoupon() {
    ...
    if (is_app) {
        if (examType == 2) {
            if (select_test_mode.value == "Online" || select_test_mode.value == "online") {
                if ((selectedNatDate.id == 380 || selectedNatDate.id == 381 || selectedNatDate.id == 378 || selectedNatDate.id == 379) && (select_course.value == 23 || select_course.value == 13 || select_course.value == 32 || select_course.value == 63)) {
                    document.getElementById("couponCode").value = 'NATMED99';
                } else if ((selectedNatDate.id == 380 || selectedNatDate.id == 381) &&
                ...
                } else if ((selectedNatDate.id == 380 || selectedNatDate.id == 381) && (select_course.value != 23 || select_course.value != 13 || select_course.value != 32 || select_course.value != 63)) {
                    document.getElementById("couponCode").value = 'NAT399';
                } else if ((selectedNatDate.id == 378 || selectedNatDate.id == 379) && (select_course.value != 23 || select_course.value != 13 || select_course.value != 32 || select_course.value != 63)) {
        ...
        if (examType == 2) {
            if (select_test_mode.value == "Online" || select_test_mode.value == "online") {
                if ((selectedNatDate.id == 380 || selectedNatDate.id == 381) && (select_course.value == 23 || select_course.value == 13 || select_course.value == 32 || select_course.value == 63)) {
        ...
        if (select_test_mode.value == "Online" || select_test_mode.value == "online") {
            if ((selectedNatDate.id == 380 || selectedNatDate.id == 381 || selectedNatDate.id == 378 || selectedNatDate.id == 379) && (select_course.value == 23 || select_course.value == 13 || select_course.value == 63)) {
                document.getElementById("couponCode").value = 'NATMED99';
            } else if ((selectedNatDate.id == 380 || selectedNatDate.id == 381) &&
                (centre_code == 176 || centre_code == 178 || centre_code == 121 || centre_code == 174 || centre_code == 177 || centre_code == 170 || centre_code == 127 || centre_code == 128 ||
                    centre_code == 134 || centre_code == 136 || centre_code == 169 || centre_code == 145 || centre_code == 147 || centre_code == 175 ||
                    ...
                    centre_code == 160 || centre_code == 164 || centre_code == 117 || centre_code == 123 || centre_code == 141 || centre_code == 144 || centre_code == 148 || centre_code == 150 ||
                    centre_code == 159 || centre_code == 161 || centre_code == 172)) {
                document.getElementById("couponCode").value = 'NATOBS99';
                //NATFOUNDATION0
            ...
            if (select_test_mode.value == "Offline" || select_test_mode.value == "offline") {
                if (select_course.value == 23 || select_course.value == 13 || select_course.value == 32 || select_course.value == 63) {
                    ...
                    document.getElementById("couponCode").value = 'NATOFBS99';
                } else if ((selectedNatDate.id == 371 || selectedNatDate.id == 377 || selectedNatDate.id == 378) && (select_course.value != 23 || select_course.value != 13 || select_course.value != 32 || select_course.value != 63)) {
                    document.getElementById("couponCode").value = 'NATOFBS99';
                } else {
                    //document.getElementById("couponCode").value = 'VIQ999';
