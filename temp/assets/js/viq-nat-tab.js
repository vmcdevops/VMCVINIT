...
function natDateOptionSelected() {
    ...
    if (is_app) {
        if (select_test_mode.value == "Online" || select_test_mode.value == "online") {
            if (selectedNatDate.id == 326 || selectedNatDate.id == 327) {
            ...
            if (selectedNatDate.id == 328 || selectedNatDate.id == 329) {
                couponCodeGlobal = 'VIQ399';
                applyCouponWithCouponCode(couponCodeGlobal);
                document.getElementById("couponCode").disabled = dalse;
                document.getElementById("couponCode").value = couponCodeGlobal;
...
function changePriceCoupon() {
    ...
    if (is_app) {
        if (examType == 3) {
            if (select_test_mode.value == "Online" || select_test_mode.value == "online") {
                if ((selectedNatDate.id == 326 || selectedNatDate.id == 327 || selectedNatDate.id == 328 || selectedNatDate.id == 329) && (select_course.value == 23 || select_course.value == 13)) {
                    document.getElementById("couponCode").value = 'VIQ99';
                } else if ((selectedNatDate.id == 326 || selectedNatDate.id == 327 || selectedNatDate.id == 328 || selectedNatDate.id == 329) && (select_course.value == 62)) {
                    document.getElementById("couponCode").value = 'VIQCUET99';
                } else if ((selectedNatDate.id == 326 || selectedNatDate.id == 327) && (select_course.value != 23 || select_course.value != 13 || select_course.value != 62)) {
                    document.getElementById("couponCode").value = 'VIQ399';
                } else if ((selectedNatDate.id == 328 || selectedNatDate.id == 329) && (select_course.value != 23 || select_course.value != 13 || select_course.value != 62)) {
                    document.getElementById("couponCode").value = 'VIQ399';
                ...
                if (select_test_mode.value == "Offline" || select_test_mode.value == "offline") {
                    if (select_course.value == 23 || select_course.value == 13) {
                        document.getElementById("couponCode").value = 'VIQ999';
                    } else if ((selectedNatDate.id == 328) && (select_course.value != 23 || select_course.value != 13)) {
                        document.getElementById("couponCode").value = 'VIQ999';
                    } else {
                        document.getElementById("couponCode").value = 'VIQ999';
                    }
...
function updateUIAsPerCartInfo() {
    ...
    if (isDiscount) {
        ...
        htmlInfo = '<span style="font-size: 18px;">&#8377 ' + parseInt(userCartSummery.total_amount) + " Only</span>";
    }
