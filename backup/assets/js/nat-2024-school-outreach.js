...
function natDateOptionSelected() {
    ...
    if (is_app) {
        if (select_test_mode.value == "Online" || select_test_mode.value == "online") {
            ...
            if (selectedNatDate.id == 382 || selectedNatDate.id == 383) {
        ...
        if (select_test_mode.value == "Offline" || select_test_mode.value == "offline") {
            if (selectedNatDate.id == 381 || selectedNatDate.id == 383) {
...
function changePriceCoupon() {
    ...
    if (is_app) {
        if (examType == 2) {
            if (select_test_mode.value == "Online" || select_test_mode.value == "online") {
                if ((selectedNatDate.id == 381 || selectedNatDate.id == 382 || selectedNatDate.id == 383) && (select_course.value == 23 || select_course.value == 13 || select_course.value == 32 || select_course.value == 63)) {
                    document.getElementById("couponCode").value = 'NATMED99';
                } else if ((selectedNatDate.id == 381 || selectedNatDate.id == 382 || selectedNatDate.id == 383) &&
                    ...
                    document.getElementById("couponCode").value = 'NAT399';
                } else if ((selectedNatDate.id == 382 || selectedNatDate.id == 383) && (select_course.value != 23 || select_course.value != 13 || select_course.value != 32 || select_course.value != 63)) {
        ...
        if (examType == 2) {
            if (select_test_mode.value == "Online" || select_test_mode.value == "online") {
                if ((selectedNatDate.id == 381 || selectedNatDate.id == 382 || selectedNatDate.id == 383) && (select_course.value == 23 || select_course.value == 13 || select_course.value == 32 || select_course.value == 63)) {
                    ...
                    document.getElementById("couponCode").value = 'VMCDMRC';
                } else if ((selectedNatDate.id == 381 || selectedNatDate.id == 382 || selectedNatDate.id == 383) && (select_course.value != 23 || select_course.value != 13 || select_course.value != 32 || select_course.value != 63)) {
                    document.getElementById("couponCode").value = 'VMCDMRC';
                }
                document.getElementById("btn_remove_coupon").disabled = true;
                applyCoupon();
        ...
        if (select_test_mode.value == "Online" || select_test_mode.value == "online") {
            if ((selectedNatDate.id == 381 || selectedNatDate.id == 382 || selectedNatDate.id == 383) && (select_course.value == 23 || select_course.value == 13 || select_course.value == 63)) {
                document.getElementById("couponCode").value = 'NATMED99';
            } else if ((selectedNatDate.id == 381 || selectedNatDate.id == 382 || selectedNatDate.id == 383) &&
                (centre_code == 176 || centre_code == 178 || centre_code == 121 || centre_code == 174 || centre_code == 177 || centre_code == 170 || centre_code == 127 || centre_code == 128 ||
                    centre_code == 134 || centre_code == 136 || centre_code == 169 || centre_code == 145 || centre_code == 147 || centre_code == 175 ||
