...
function updateOfflineCentre(courseListJSON) {
    ...
    for (i = 0; i < courseListArr.length; i++) {
        ...
        if (course.code == '151' || course.code == '152' || course.code == '153' || course.code == '195') {
...
function prepareNatDateOptionsSelection(natDatesList) {
    ...
    for (i = 0; i < natDatesList.length; i++) {
        ...
        if (natDate.testDate == '2024-05-11') {
            if (i == 0 || i == 1) {
...
function changePriceCoupon() {
    ...
    if (is_app) {
        if (examType == 2) {
            if (select_test_mode.value == "Online" || select_test_mode.value == "online") {
                if ((selectedNatDate.id == 359 || selectedNatDate.id == 360) && (select_course.value == 23 || select_course.value == 13)) {
                ...
                if (select_test_mode.value == "Offline" || select_test_mode.value == "offline") {
                    if (select_course.value == 23 || select_course.value == 13) {
                        document.getElementById("couponCode").value = 'NATPAT0M';
