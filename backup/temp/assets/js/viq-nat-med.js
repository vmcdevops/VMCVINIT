...
function prepareNatDateOptionsSelection(natDatesList) {
    ...
    for (i = 0; i < natDatesList.length; i++) {
        if (i == 0 || i == 1 || i == 2 || i == 3 || i == 8 || i == 9 || i == 10 || i == 11 || i == 12 || i == 13) {
...
function natDateOptionSelected() {
    ...
    if (select_test_mode.value == "Online" || select_test_mode.value == "online") {
        if (selectedNatDate.id == 341 || selectedNatDate.id == 343 || selectedNatDate.id == 344 || selectedNatDate.id == 345) {
            couponCodeGlobal = 'VIQPLUSMED99';
    ...
    if (is_app) {
        if (examType == 2) {
            ...
            if (select_test_mode.value == "Offline" || select_test_mode.value == "offline") {
                // const limitDate2 = new Date('2022-09-25');
                // if (today <= limitDate2) {
...
function updateCentersOptions(centerListJSON) {
    ...
    for (i = 0; i < centerListArr.length; i++) {
        ...
        if (center.code == '101' || center.code == '102' ||
            center.code == '104' || center.code == '105' || center.code == '106' || center.code == '107' ||
            center.code == '108' || center.code == '109' || center.code == '110' || center.code == '111' ||
            center.code == '113' || center.code == '119' || center.code == '187' || center.code == '137' ||
            center.code == '142' || center.code == '143' ||
            center.code == '166' || center.code == '163' || center.code == '151' ||
            center.code == '152' || center.code == '153' || center.code == '195') {
