...
function natDateOptionSelected() {
    ...
    if (select_test_mode.value == "Online" || select_test_mode.value == "online") {
        if (selectedNatDate.id == 322 || selectedNatDate.id == 323 || selectedNatDate.id == 324 || selectedNatDate.id == 325) {
            couponCodeGlobal = 'VIQSPL49';
...
function changePriceCoupon() {
    ...
    if (is_app) {
        if (examType == 3) {
            if (select_test_mode.value == "Online" || select_test_mode.value == "online") {
                if (selectedNatDate.id == 322 || selectedNatDate.id == 323 || selectedNatDate.id == 324 || selectedNatDate.id == 325) {
                    document.getElementById("couponCode").value = 'VIQSPL49';
                } else if (selectedNatDate.id == 326 || selectedNatDate.id == 327 || selectedNatDate.id == 328 || selectedNatDate.id == 329) {
                    document.getElementById("couponCode").value = 'VIQSPL99';
                } else {
                    document.getElementById("couponCode").value = 'VIQSPL0';
                }
            } else {
        ...
        const limitDate2 = new Date('2023-10-29');
        if (today <= limitDate2) {
            document.getElementById("couponCode").value = "VIQSPL299";
        } else {
            document.getElementById("couponCode").value = "VIQSPL299";
        }
        document.getElementById("btn_remove_coupon").disabled = true;
        applyCoupon();
    } else if ((selectedNatDate.id == 334 || selectedNatDate.id == 335 || selectedNatDate.id == 336 || selectedNatDate.id == 337 || selectedNatDate.id == 338 || selectedNatDate.id == 339) &&
        ...
        let amount = selectedNatDate.amount ? selectedNatDate.amount : 99;
