...
function prepareNatDateOptionsSelection(natDatesList) {
    ...
    for (i = 0; i < natDatesList.length; i++) {
        ...
        if (natDate.testDate == '2023-10-07' || natDate.testDate == '2023-10-08' || natDate.testDate == '2023-10-12' || natDate.testDate == '2023-10-13') {
    ...
    if (defaultCouponApplied == false) {
        ...
        if (is_app) {
            if (examType == 2) {
                ...
                document.getElementById("couponCode").value = `${TEST_TYPE}APPFREE`;
            }
        } else {
...
function updateContactUserDetails() {
    ...
    var preferedTestDateId = document.getElementById("select_nat_date").value;
    /***************** surendra 18-08-2023 **************/
    ...
    var json = {
        params: {
            ...
            test_date: document.getElementById("select_nat_date").text,
            /***************** surendra 18-08-2023 **************/
...
function calculateHashValuesSuccess(responseText) {
    ...
    //alert(document.getElementById('school_address').value);
...
*/
    ...
    var address = document.getElementById("school_address").value.trim();
    if (address == undefined || address == null || address.length == 0) {
        document.getElementById("select_city_error").innerHTML = "Please enter school locality";
        return true;
    }
...
function startNATRegistrationProcess() {
    ...
    var exam_test_id = document.getElementById("select_nat_date").value;
    /***************** surendra 18-08-2023 **************/
...
function updateCoursesOptions(courseListJSON) {
    ...
    for (i = 0; i < courseListArr.length; i++) {
        var course = courseListArr[i];
        var option = document.createElement("option");
        if (course.code == '41' || course.code == '31' || course.code == '22' ||
            course.code == '23' || course.code == '12' || course.code == '13') {
            option.value = course.code;
            option.text = course.value;
            elCourses.add(option);
        }
